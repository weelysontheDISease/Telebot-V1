...
def parade_state(update, context):
	...
	parade_state_text = f"""DIS WING 14/26 PRE-MDST PARADE STATE {current_date}, {current_time}H
-------------------------------------------------------- 
...
{permstatus_text}
"""
	context.bot.send_message(chat_id=update.effective_chat.id, text=parade_state_text)
